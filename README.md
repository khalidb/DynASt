...
The *Results* folder, which you will need to create and add to the classpath, contains the the files outputs by DynASt, with information about the performance for processing the batches of a given dataset.
