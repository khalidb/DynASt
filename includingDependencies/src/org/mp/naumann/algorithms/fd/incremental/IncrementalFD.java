...
public class IncrementalFD implements IncrementalAlgorithm<IncrementalFDResult, FDIntermediateDatastructure> {
    ...
    public void initialize(FDIntermediateDatastructure intermediateDatastructure) {
        ...
        System.out.println("version.recomputesDataStructures(): "+version.recomputesDataStructures());
        System.out.println("version.getVersionName(): "+version.getVersionName());
        System.out.println("IncrementalFDConfiguration.LATEST.getVersionName()"+ IncrementalFDConfiguration.LATEST.getVersionName());
    ...
    public IncrementalFDResult execute(Batch batch) throws AlgorithmExecutionException {
        ...
        System.out.println("Batch size: "+batch.getSize());
        
        
        FDLogger.log(Level.FINER, "Started updating data structures");
        CompressedDiff diff = dataStructureBuilder.update(batch);
       
        System.out.println("has delete? "+diff.hasDeletes());
        System.out.println("has insert? "+diff.hasInserts());
        ...
        if (diff.hasDeletes()) {
        	...
        	System.out.println("Treat the detele case");
        ...
        if (diff.hasInserts()) {
        	System.out.println("Treat the insert case");
        ...
        durations.add(benchmark.finish().getDurationInMillis());
        
        for (int i =0; i<durations.size();i++)
        	System.out.println("Batch "+(i)+" took "+durations.get(i));
